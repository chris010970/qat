...
class Farm:
    ...
    def loadImages( self, path, prefix ):
        ...
        rgb = np.array( imread( os.path.join( path, 'images/{p}.tif'.format( p=prefix ) ) ), dtype=np.uint16 )
        ...
        def copySubset( images, subset ):
            ...
            for image in images:
                ...
                if os.path.exists ( mask ):
                    ...
                    copyFile( mask, os.path.join( out_path, 'labels/farm/' ) )
...
# create test object
obj = Farm( 64, 64, 9 )
params = {  'image_path' : 'C:\\Users\\crwil\\Documents\\chips\\subset2\\images',
            'mask_path' : 'C:\\Users\\crwil\\Documents\\chips\\subset2\\labels\\farm',
            'out_path' : 'C:\\Users\\crwil\\Documents\\chips\\data\\' 
}

#obj.splitDataset( params )
#obj.splitDataset( params, train_pc=0.0, val_pc=0.5, test_pc=0.5 )
