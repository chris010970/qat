...
class Train:
    ...
    def __init__( self, args ):
        ...
        self._channels = 9
        self._obj = Farm( args.rows, args.cols, self._channels )

        # create xnet model from scratch
        self._model = models.unet_2d((None, None, 9), [64, 128, 256], n_labels=2,
    ...
    def process( self, args ):
        ...
        self._model.compile(    optimizer=opt, 
                                loss=dice_coef,
                                metrics=["binary_crossentropy", weighted_binary_crossentropy, dice_coef ] )
